                ...
                if (moveTargets != null && moveTargets.Count > 0)
                {
                    ...
                    if (foodMachine.foodStack.foodStack.Count > 0)
                    {
                        ...
                        while (true)
                        {
                            ...
                            Vector3 targetPosition = headPoint.position + new Vector3(0, 0.7f * (currentStackCount + 1), 0); // 목적지 저장
                ...
                if (moveTargets != null && moveTargets.Count > 0)
                {
                    ...
                    for (int i = 0; i < counter.foodStacks.Count; i++)
                    {
                        ...
                        while (foodStack.foodStack.Count > 0)
                        {
                            ...
                            Vector3 targetPosition = headPoint.position + new Vector3(0, 0.7f * (currentStackCount + 1), 0); // 목적지
#if HAS_DOTWEEN
                            //  DOTween.Kill(f.transforms); //Tween 제거
