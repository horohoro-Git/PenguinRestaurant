...
public class Order : MonoBehaviour
{
    ...
    {
        Vector3 p1 = new Vector3(-54f, 140, -54f);
        ...
        if (count == 0)
        {
            Vector3 p2 = new Vector3(-0.8f, 0, 0);
            foodImage1.rectTransform.localPosition = p2;
            Vector3 p3 = new Vector3(0.95f, -0.2f, 0f);
        ...
        if (count == 1)
        {
            Vector3 p2 = new Vector3(-0.8f, -0.8f, 0);
            foodImage1.rectTransform.localPosition = p2;
            Vector3 p3 = new Vector3(0.95f, -1f, 0f);
            foodNum1.rectTransform.localPosition = p3;
